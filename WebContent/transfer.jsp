...
<div class="container-fluid text-center">
	<div class="row-content">
		...
		<div class="col-sm-8 text-left">
			<h1>Enter the details to transfer money</h1>
			<div class="container-fluid">
				<form action="./transfer" method="post">
					<div class="form-group">
						<label for="accno1">Sender's Account no.:</label>
						<input type="number" class="form-control" id="accno1" placeholder="Enter account no." name="accno1">
					</div>
					<div class="form-group">
						<label for="balance">Amount:</label>
						<input type="text" class="form-control" id="balance" placeholder="Enter amount" name="balance">
					</div>
					<div class="form-group">
						<label for="accno2">reciever's Account no.:</label>
						<input type="number" class="form-control" id="accno2" placeholder="Enter account no." name="accno2">
					</div>
