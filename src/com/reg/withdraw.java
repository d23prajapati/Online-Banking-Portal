...
public class withdraw extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			int withdrawMoney = Integer.parseInt(request.getParameter("balance"));
			int accno = Integer.parseInt(request.getParameter("accno"));
			stmt.setInt(1, withdrawMoney);
			stmt.setInt(2, accno);
			stmt.executeUpdate();
			
			out.print("Withdraw " + withdrawMoney + " Rs Successfully");
			
			out.print("<br><a href=\"withdraw.jsp\">Back</a><br>");
